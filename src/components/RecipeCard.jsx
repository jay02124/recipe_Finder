import { Heart, HeartPulse, Salad } from "lucide-react";
	...
	return (
		<div className={`flex flex-col rounded-md ${bg} overflow-hidden p-3 relative`}>
			...
			>
				...
				/>
				<div
					className='absolute bottom-2 right-2 bg-white rounded-full p-1 cursor-pointer flex items-center
							 gap-1 text-sm
							'
				>
					<Salad size={15} />  {recipe.yield} Serving
				</div>

				<div
					className='absolute top-1 left-2 bg-white rounded-full p-1 cursor-pointer'
					onClick={(e) => {
						e.preventDefault();
